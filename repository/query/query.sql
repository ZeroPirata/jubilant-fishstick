...
-- SELECT de, para FROM stack_aliases;

-- -- name: QueryInsertStackAlias :one
-- INSERT INTO stack_aliases(de, para) VALUES ($1, $2) RETURNING *;

-- -- name: QueryDeleteStackAlias :exec
-- DELETE FROM stack_aliases WHERE id = $1;

-- -- name: QuerySelectAllStackAliasesWithID :many
-- SELECT id, de, para FROM stack_aliases ORDER BY de;
